      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 max-w-md w-full text-center shadow-2xl border border-white/20">
        <div className="mb-6">
          <div className="flex justify-center space-x-4 mb-4">
            <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center animate-pulse3d">
              <Monitor className="w-8 h-8 text-white" />
            </div>
            <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center animate-pulse3d" style={{ animationDelay: '1s' }}>
